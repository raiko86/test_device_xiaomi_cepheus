...
public class DozeSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        PreferenceCategory pickupSensorCategory = (PreferenceCategory) getPreferenceScreen().findPreference(
                DozeUtils.CATEG_PICKUP_SENSOR);
        PreferenceCategory proximitySensorCategory = (PreferenceCategory) getPreferenceScreen().findPreference(
        ...
        // Hide AOD and doze brightness if not supported and set all its dependents
        // otherwise
