...
class BatchingAdapter : public LocAdapterBase {
  ...
  void stopTripBatchingMultiplexCommon(LocationError err, LocationAPI* client,
 ...
 public:
  ...
  void setBatchingTimeout(uint32_t batchingTimeout) {
    mBatchingTimeout = batchingTimeout;
  }
