...
typedef std::map<uint32_t, GeofenceObject>
    GeofencesMap;  // map of hwId to GeofenceObject
typedef std::map<GeofenceKey, uint32_t>
    GeofenceIdMap;  // map of GeofenceKey to hwId
...
class GeofenceAdapter : public LocAdapterBase {
 ...
 public:
  ...
  /* ======== RESPONSES
   * ================================================================== */
  void reportResponse(LocationAPI* client, size_t count, LocationError* errs,
                      uint32_t* ids);
  /* ======== UTILITIES
   * ================================================================== */
  ...
  LocationError getHwIdFromClient(LocationAPI* client, uint32_t clientId,
                                  uint32_t& hwId);
