...
uint32_t LocAdapterBase::generateSessionId() {
  if (++mSessionIdCounter == 0xFFFFFFFF) mSessionIdCounter = 1;
...
void LocAdapterBase::reportPositionEvent(
  ...
  if (mLocAdapterProxyBase != NULL) {
    mLocAdapterProxyBase->reportPositionEvent(
        (UlpLocation&)location, (GpsLocationExtended&)locationExtended, status,
        loc_technology_mask);
  } else {
    DEFAULT_IMPL()
  }
...
void LocAdapterBase::reportSvEvent(const GnssSvNotification& /*svNotify*/,
    ...
    void LocAdapterBase::reportSvPolynomialEvent(
        ...
        void LocAdapterBase::reportSvEphemerisEvent(
            ...
            void LocAdapterBase::reportStatus(
                LocGpsStatusValue /*status*/) DEFAULT_IMPL()

                void LocAdapterBase::reportNmeaEvent(
                    const char* /*nmea*/, size_t /*length*/) DEFAULT_IMPL()

                    void LocAdapterBase::reportDataEvent(
                        const GnssDataNotification& /*dataNotify*/,
                        int /*msInWeek*/) DEFAULT_IMPL()

                        bool LocAdapterBase::reportXtraServer(
                            const char* /*url1*/, const char* /*url2*/,
                            const char* /*url3*/,
                            const int /*maxlength*/) DEFAULT_IMPL(false)

                            void LocAdapterBase::reportLocationSystemInfoEvent(
                                const LocationSystemInfo& /*locationSystemInfo*/) DEFAULT_IMPL()

                                bool LocAdapterBase::requestXtraData() DEFAULT_IMPL(
                                    false)

                                    bool LocAdapterBase::requestTime() DEFAULT_IMPL(
                                        false)

                                        bool LocAdapterBase::requestLocation() DEFAULT_IMPL(
                                            false)

                                            bool LocAdapterBase::requestATL(
                                                int /*connHandle*/,
                                                LocAGpsType /*agps_type*/,
                                                LocApnTypeMask /*apn_type_mask*/) DEFAULT_IMPL(false)
                                                ...
                                                bool LocAdapterBase::releaseATL(
                                                    ...
                                                    bool LocAdapterBase::requestNiNotifyEvent(
                                                        ...
                                                        ,
                                                        const void* /*data*/,
                                                        const LocInEmergency
                                                            emergencyState) DEFAULT_IMPL(false)

                                                        void LocAdapterBase::reportGnssMeasurementsEvent(
                                                            const GnssMeasurements& /*gnssMeasurements*/
                                                            ,
                                                            int /*msInWeek*/) DEFAULT_IMPL()

                                                            bool LocAdapterBase::reportWwanZppFix(
                                                                LocGpsLocation& /*zppLoc*/) DEFAULT_IMPL(false)

                                                                bool LocAdapterBase::reportZppBestAvailableFix(
                                                                    ...
                                                                    void LocAdapterBase::reportGnssSvIdConfigEvent(
                                                                        const GnssSvIdConfig& /*config*/)
                                                                        DEFAULT_IMPL()

                                                                            void LocAdapterBase::reportGnssSvTypeConfigEvent(
                                                                                const GnssSvTypeConfig& /*config*/)
                                                                                DEFAULT_IMPL()

                                                                                    void LocAdapterBase::reportGnssConfigEvent(
                                                                                        uint32_t, /* session id*/
                                                                                        ...
                                                                                        DEFAULT_IMPL()
                                                                                            ...
                                                                                            bool LocAdapterBase::
                                                                                                requestOdcpiEvent(
                                                                                                    OdcpiRequestInfo& /*request*/)
                                                                                                    DEFAULT_IMPL(
                                                                                                        false)

                                                                                                        bool LocAdapterBase::
                                                                                                            reportGnssEngEnergyConsumedEvent(
                                                                                                                uint64_t /*energyConsumedSinceFirstBoot*/)
                                                                                                                DEFAULT_IMPL(
                                                                                                                    false)

                                                                                                                    bool LocAdapterBase::
                                                                                                                        reportDeleteAidingDataEvent(
                                                                                                                            GnssAidingData& /*aidingData*/)
                                                                                                                            DEFAULT_IMPL(
                                                                                                                                false)

                                                                                                                                bool LocAdapterBase::reportKlobucharIonoModelEvent(GnssKlobucharIonoModel& /*ionoModel*/) DEFAULT_IMPL(false)
                                                                                                                                    ...
                                                                                                                                    bool LocAdapterBase::
                                                                                                                                        reportGnssAdditionalSystemInfoEvent(
                                                                                                                                            ...
                                                                                                                                            DEFAULT_IMPL(
                                                                                                                                                ...
                                                                                                                                                void LocAdapterBase::
                                                                                                                                                    reportNfwNotificationEvent(
                                                                                                                                                        GnssNfwNotification& /*notification*/)
                                                                                                                                                        DEFAULT_IMPL()

                                                                                                                                                            void LocAdapterBase::geofenceBreachEvent(size_t /*count*/
                                                                                                                                                                                                     ,
                                                                                                                                                                                                     uint32_t* /*hwIds*/,
                                                                                                                                                                                                     Location& /*location*/
                                                                                                                                                                                                     ,
                                                                                                                                                                ...
                                                                                                                                                                DEFAULT_IMPL()
                                                                                                                                                                    ...
                                                                                                                                                                    void LocAdapterBase::geofenceStatusEvent(
                                                                                                                                                                        GeofenceStatusAvailable /*available*/)
                                                                                                                                                                        DEFAULT_IMPL()

                                                                                                                                                                            void LocAdapterBase::reportLocationsEvent(const Location* /*locations*/,
                                                                                                                                                                                                                      size_t /*count*/
                                                                                                                                                                                                                      ,
                                                                                                                                                                                                                      BatchingMode /*batchingMode*/)
                                                                                                                                                                                DEFAULT_IMPL()

                                                                                                                                                                                    void LocAdapterBase::reportCompletedTripsEvent(
                                                                                                                                                                                        uint32_t /*accumulated_distance*/)
                                                                                                                                                                                        DEFAULT_IMPL()

                                                                                                                                                                                            void LocAdapterBase::reportBatchStatusChangeEvent(BatchingStatus /*batchStatus*/) DEFAULT_IMPL()
                                                                                                                                                                                                ...
                                                                                                                                                                                                void LocAdapterBase::reportPositionEvent(
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    DEFAULT_IMPL()
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        void LocAdapterBase::saveClient(LocationAPI* client,
...
LocationCapabilitiesMask LocAdapterBase::getCapabilities() {
  ...
  if (isEngineCapabilitiesKnown()) {
    ...
    LOC_LOGE("%s]: attempt to get capabilities before they are known.",
             __func__);
  }
...
void LocAdapterBase::updateClientsEventMask() DEFAULT_IMPL()
    ...
    void LocAdapterBase::stopClientSessions(LocationAPI* client) DEFAULT_IMPL()
        ...
        void LocAdapterBase::addClientCommand(
...
void LocAdapterBase::removeClientCommand(
    LocationAPI* client, removeClientCompleteCallback rmClientCb) {
  LOC_LOGD("%s]: client %p", __func__, client);
