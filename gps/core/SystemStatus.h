...
#define GAL_NUM (36)
#define NAVIC_NUM (14)
#define SV_ALL_NUM_MIN \
  (GPS_NUM + GLO_NUM + QZSS_NUM + BDS_NUM + GAL_NUM)  //=134
...
class SystemStatusWifiHardwareState : public SystemStatusItemBase,
 ...
 public:
  ...
  inline SystemStatusWifiHardwareState(
      const WifiHardwareStateDataItemBase& itemBase)
...
class SystemStatusNetworkInfo : public SystemStatusItemBase,
 ...
 public:
  inline SystemStatusNetworkInfo(
      int32_t type = 0, std::string typeName = "", string subTypeName = "",
  ...
  inline virtual SystemStatusItemBase& collate(SystemStatusItemBase& curInfo) {
    uint64_t allTypes =
        (static_cast<SystemStatusNetworkInfo&>(curInfo)).mAllTypes;
    ...
    if (mConnected) {
      ...
      for (; lastValidIndex < MAX_NETWORK_HANDLES &&
             NETWORK_HANDLE_UNKNOWN !=
                 mAllNetworkHandles[lastValidIndex].networkHandle;
           ++lastValidIndex) {
...
class SystemStatusPowerConnectState : public SystemStatusItemBase,
 ...
 public:
  ...
  inline SystemStatusPowerConnectState(
      const PowerConnectStateDataItemBase& itemBase)
...
class SystemStatusTimeZoneChange : public SystemStatusItemBase,
 ...
 public:
  inline SystemStatusTimeZoneChange(int64_t currTimeMillis = 0ULL,
                                    int32_t rawOffset = 0,
                                    int32_t dstOffset = 0)
...
class SystemStatusTimeChange : public SystemStatusItemBase,
 ...
 public:
  inline SystemStatusTimeChange(int64_t currTimeMillis = 0ULL,
                                int32_t rawOffset = 0, int32_t dstOffset = 0)
...
class SystemStatusWifiSupplicantStatus
    : public SystemStatusItemBase,
      public WifiSupplicantStatusDataItemBase {
 public:
  inline SystemStatusWifiSupplicantStatus()
      : WifiSupplicantStatusDataItemBase() {}
  inline SystemStatusWifiSupplicantStatus(
      const WifiSupplicantStatusDataItemBase& itemBase)
...
class SystemStatusBtDeviceScanDetail : public SystemStatusItemBase,
 ...
 public:
  ...
  inline SystemStatusBtDeviceScanDetail(
      const BtDeviceScanDetailsDataItemBase& itemBase)
  ...
  inline bool equals(const SystemStatusBtDeviceScanDetail& peer) {
    return ((mApSrnRssi == peer.mApSrnRssi) &&
            (0 == memcmp(mApSrnMacAddress, peer.mApSrnMacAddress,
                         sizeof(mApSrnMacAddress))) &&
...
class SystemStatusBtleDeviceScanDetail
    : public SystemStatusItemBase,
 ...
 public:
  ...
  inline SystemStatusBtleDeviceScanDetail(
      const BtLeDeviceScanDetailsDataItemBase& itemBase)
...
class SystemStatus {
 ...
 public:
  ...
  // Helpers
  bool eventPosition(const UlpLocation& location,
                     const GpsLocationExtended& locationEx);
