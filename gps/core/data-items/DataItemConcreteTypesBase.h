...
typedef struct NetworkInfoType {
  ...
  NetworkInfoType()
      : networkHandle(NETWORK_HANDLE_UNKNOWN), networkType(TYPE_UNKNOWN) {}
  NetworkInfoType(string strObj) {
    ...
    if (posDelimit != string::npos) {
      ...
      string typeStr =
          strObj.substr(posDelimit + 1, strObj.length() - posDelimit - 1);
  ...
  bool operator==(const NetworkInfoType& other) {
    return ((networkHandle == other.networkHandle) &&
...
class AirplaneModeDataItemBase : public IDataItemCore {
 public:
  ...
  virtual int32_t copy(IDataItemCore* /*src*/,
                       bool* /*dataItemCopied = NULL*/) {
    return 1;
  }
  // Data members
  bool mMode;
...
class TimeZoneChangeDataItemBase : public IDataItemCore {
 public:
  TimeZoneChangeDataItemBase(int64_t currTimeMillis, int32_t rawOffset,
                             int32_t dstOffset)
...
class TimeChangeDataItemBase : public IDataItemCore {
 public:
  TimeChangeDataItemBase(int64_t currTimeMillis, int32_t rawOffset,
                         int32_t dstOffset)
      : mCurrTimeMillis(currTimeMillis),
        mRawOffsetTZ(rawOffset),
        mDstOffsetTZ(dstOffset),
...
class NetworkInfoDataItemBase : public IDataItemCore {
 public:
  NetworkInfoDataItemBase(NetworkType initialType, int32_t type,
                          string typeName, string subTypeName, bool available,
                          bool connected, bool roaming, uint64_t networkHandle)
...
class RilServiceInfoDataItemBase : public IDataItemCore {
 public:
  ...
  inline virtual bool operator==(
      const RilServiceInfoDataItemBase& other) const {
...
class BtDeviceScanDetailsDataItemBase
    : public SrnDeviceScanDetailsDataItemBase {
 public:
...
class BtLeDeviceScanDetailsDataItemBase
    : public SrnDeviceScanDetailsDataItemBase {
 public:
