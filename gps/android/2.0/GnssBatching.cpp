...
Return<bool> GnssBatching::init(
  ...
  if (mGnssBatchingCbIface != nullptr) {
    mGnssBatchingCbIface->linkToDeath(mGnssBatchingDeathRecipient,
                                      0 /*cookie*/);
  }
...
Return<bool> GnssBatching::init_2_0(
  ...
  if (mGnssBatchingCbIface_2_0 != nullptr) {
    mGnssBatchingCbIface_2_0->linkToDeath(mGnssBatchingDeathRecipient,
                                          0 /*cookie*/);
  }
