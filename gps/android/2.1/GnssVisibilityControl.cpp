...
static void convertGnssNfwNotification(
    GnssNfwNotification& in,
...
static void convertGnssNfwNotification(
  ...
  out.protocolStack =
      (IGnssVisibilityControlCallback::NfwProtocolStack)in.protocolStack;
  ...
  out.responseType =
      (IGnssVisibilityControlCallback::NfwResponseType)in.responseType;
