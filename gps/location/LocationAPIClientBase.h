...
class LocationAPIControlClient {
 public:
  ...
  void onCtrlCollectiveResponseCb(size_t count, LocationError* errors,
                                  uint32_t* ids);
  ...
  inline virtual void onGnssUpdateConfigCb(size_t /*count*/,
                                           LocationError* /*errors*/,
                                           uint32_t* /*ids*/) {}
  inline virtual void onGnssGetConfigCb(size_t /*count*/,
                                        LocationError* /*errors*/,
                                        uint32_t* /*ids*/) {}
  ...
  class GnssUpdateConfigRequest : public LocationAPIRequest {
   public:
    ...
    inline void onCollectiveResponse(size_t count, LocationError* errors,
                                     uint32_t* ids) {
...
class LocationAPIClientBase {
 public:
  ...
  void locAPIModifyGeofences(size_t count, uint32_t* ids,
                             GeofenceOption* options);
  void locAPIPauseGeofences(size_t count, uint32_t* ids);
  void locAPIResumeGeofences(size_t count, uint32_t* ids,
  ...
  void onCollectiveResponseCb(size_t count, LocationError* errors,
                              uint32_t* ids);

  void beforeGeofenceBreachCb(
      GeofenceBreachNotification geofenceBreachNotification);

  inline virtual void onCapabilitiesCb(
      LocationCapabilitiesMask /*capabilitiesMask*/) {}
  inline virtual void onGnssNmeaCb(
      GnssNmeaNotification /*gnssNmeaNotification*/) {}
  inline virtual void onGnssDataCb(
  ...
  inline virtual void onBatchingStatusCb(
      BatchingStatusInfo /*batchingStatus*/,
  ...
  inline virtual void onAddGeofencesCb(size_t /*count*/,
                                       LocationError* /*errors*/,
                                       uint32_t* /*ids*/) {}
  inline virtual void onRemoveGeofencesCb(size_t /*count*/,
                                          LocationError* /*errors*/,
                                          uint32_t* /*ids*/) {}
  inline virtual void onModifyGeofencesCb(size_t /*count*/,
                                          LocationError* /*errors*/,
                                          uint32_t* /*ids*/) {}
  inline virtual void onPauseGeofencesCb(size_t /*count*/,
                                         LocationError* /*errors*/,
                                         uint32_t* /*ids*/) {}
  inline virtual void onResumeGeofencesCb(size_t /*count*/,
                                          LocationError* /*errors*/,
                                          uint32_t* /*ids*/) {}
  ...
  inline virtual void onLocationSystemInfoCb(
 ...
 private:
  ...
  class AddGeofencesRequest : public LocationAPIRequest {
   public:
    ...
    inline void onCollectiveResponse(size_t count, LocationError* errors,
      ...
      LOC_LOGD("%s:]Returned geofence-id: %d in add geofence", __FUNCTION__,
               *ids);
  ...
  class RemoveGeofencesRequest : public LocationAPIRequest {
   public:
    RemoveGeofencesRequest(
        LocationAPIClientBase& API,
    ...
    inline void onCollectiveResponse(size_t count, LocationError* errors,
      ...
      if (nullptr != mRemovedGeofenceBiDict) {
        ...
        LOC_LOGD("%s:]Returned geofence-id: %d in remove geofence",
                 __FUNCTION__, *ids);
        mAPI.onRemoveGeofencesCb(count, errors, ids);
        free(ids);
        delete (mRemovedGeofenceBiDict);
      } else {
        LOC_LOGE("%s:%d] Unable to access removed geofences data.",
