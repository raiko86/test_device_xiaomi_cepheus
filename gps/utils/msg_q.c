/* Copyright (c) 2011-2012, 2014, 2017 The Linux Foundation. All rights
 * reserved.
 *
...
static msq_q_err_type convert_linked_list_err_type(
    linked_list_err_type linked_list_val) {
...
msq_q_err_type msg_q_snd(void* msg_q_data, void* msg_obj,
  ...
  rv = convert_linked_list_err_type(
      linked_list_add(p_msg_q->msg_list, msg_obj, dealloc));
...
msq_q_err_type msg_q_rcv(void* msg_q_data, void** msg_obj) {
  ...
  rv = convert_linked_list_err_type(
      linked_list_remove(p_msg_q->msg_list, msg_obj));
